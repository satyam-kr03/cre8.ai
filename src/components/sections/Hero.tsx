...
// Then use DynamicLottie instead of Lottie
      ...
      <div className="relative max-w-screen-xl mx-auto px-4 text-center">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-xl z-0 opacity-30 pointer-events-none">
          <div style={{ filter: "brightness(200%) contrast(0)" }}>
            <DynamicLottie animationData={helloAnimationData} />
          </div>
        </div>

        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-16 mt-16 relative z-10">
          ...
          <Tabs defaultValue="image" className="w-full">
            <TabsContent value="video" className="w-full">
              <div className="flex w-full max-w-2xl mx-auto rounded-full bg-white shadow-lg overflow-hidden">
                ...
                />
                <Button className="rounded-r-full bg-blue-600 hover:bg-blue-700 px-6">
                  Generate
                </Button>
              </div>
            </TabsContent>
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-6">
          <Link href="/create/text">
            <Button
              variant="outline"
              className="rounded-full bg-white shadow-sm px-6 py-3 text-base"
            >
              <svg
              ...
              >
                <path
                  d="M3 17.25V21H6.75L17.81 9.94L14.06 6.19L3 17.25ZM20.71 7.05C21.1 6.66 21.1 6.02 20.71 5.63L18.37 3.29C17.98 2.9 17.34 2.9 16.95 3.29L15.88 4.36L19.64 8.12L20.71 7.05Z"
                  fill="currentColor"
                />
              </svg>
              Text
