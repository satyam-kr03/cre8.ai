        ...
        try {
            ...
            const requestData: GeminiRequest = {
                contents: [
                    {
                        parts: [
                            { text: "Analyze this image. Describe its key elements, mood, and composition. Generate a short, evocative prompt suitable for transforming this image into a Pixar-inspired art style, focusing on the characteristic Pixar 3D animation style, vibrant colors, and expressive characters." } as TextPart,
                            {
                                inline_data: {
            ...
            <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
                ...
                <div className="w-full md:w-[300px] bg-gray-50 p-5 overflow-y-auto border-r border-gray-200">
                    ...
                    <div className="space-y-5">
                        <h2 className="text-lg font-semibold text-gray-800 mb-3">Pixar Style Settings</h2>
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center">
                            <div className="relative w-full h-[calc(100vh-340px)] min-h-[300px] max-h-[60vh] rounded-xl overflow-hidden shadow-md bg-gray-200 flex items-center justify-center">
                                ...
                                <div className="z-10 flex flex-col items-center">
                                    ...
                                    <div className="text-xl sm:text-2xl font-bold text-gray-800 text-center px-4">Generating Pixar style...</div>
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center">
                            <div className="w-24 h-24 sm:w-28 sm:h-28 opacity-50 mb-4">
                                ...
                                <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-blue-400">
                                    ...
                                    <path d="M50 25V75M25 50H75" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
                                    <circle cx="50" cy="50" r="10" fill="currentColor" opacity="0.5"/>
                                </svg>
                            </div>
                            <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-center text-gray-800">Pixar Style Image Generator</h1>
                            <p className="text-center text-gray-600 max-w-xl mb-8 px-4">
                                Upload an image and transform it into the delightful Pixar 3D animation art style.
                            </p>
                        </div>
                    ) : (
                        <div className="flex-1 flex flex-col items-center justify-center">
