...
const GhibliGenerator = () => {
    ...
    const [strength, setStrength] = useState(0.8); // Default strength for Ghibli style
        ...
        try {
            ...
            const requestData: GeminiRequest = {
                contents: [
                    {
                        parts: [
                            { text: "Analyze this image. Describe its key elements, mood, and composition. Generate a short, evocative prompt suitable for transforming this image into a Ghibli-inspired art style, focusing on atmosphere and charm." } as TextPart,
                            {
                                inline_data: {
                ...
                generation_config: {
                    temperature: 0.7,
                    max_output_tokens: 150 // Shorter prompt for Ghibli style
                }
            };
            
            console.log("Sending image to Gemini for Ghibli prompt generation...");
            ...
            console.log("Generated Ghibli prompt from image:", generatedPrompt);
    ...
    const generateGhibliImage = async () => {
        ...
        if (!uploadedImage) {
            alert("Please upload an image first to generate a Ghibli-style version.");
            return;
        }
        ...
        try {
            ...
            console.log('Sending request to generate Ghibli image...');
            ...
            try {
                ...
                console.log('Successfully created Ghibli image URL');
            } catch (e) {
            ...
            alert("An error occurred while generating the Ghibli image: " + (error instanceof Error ? error.message : String(error)));
        } finally {
                ...
                <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
                    ...
                    <div className="w-full md:w-[300px] bg-gray-50 p-5 overflow-y-auto border-r border-gray-200">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="mr-2 text-blue-600">
                                     {/* Ghibli-esque icon (simple leaf or tree) */}
                        ...
                        <div className="space-y-5">
                            <h2 className="text-lg font-semibold text-gray-800 mb-3">Ghibli Style Settings</h2>
                    ...
                    <div className="flex-1 flex flex-col p-5 overflow-y-auto bg-gray-50">
                        {isGenerating ? (
                            <div className="flex-1 flex flex-col items-center justify-center">
                                <div className="relative w-full h-[calc(100vh-340px)] min-h-[300px] max-h-[60vh] rounded-xl overflow-hidden shadow-md bg-gray-200 flex items-center justify-center">
                                    ...
                                    <div className="z-10 flex flex-col items-center">
                                        ...
                                        <div className="text-xl sm:text-2xl font-bold text-gray-800 text-center px-4">Generating Ghibli style...</div>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center">
                                ...
                                <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-center text-gray-800">Ghibli Style Image Generator</h1>
                                <p className="text-center text-gray-600 max-w-xl mb-8 px-4">
                                    Upload an image and transform it into the charming Ghibli art style.
                                </p>
                            </div>
                        ) : (
                            <div className="flex-1 flex flex-col items-center justify-center">
                                <div className="relative w-full h-[calc(100vh-340px)] min-h-[300px] max-h-[60vh] rounded-xl overflow-hidden shadow-sm border border-gray-100 bg-gray-100 flex items-center justify-center">
                                    <Image 
                                        src={generatedImage}
                                        alt={prompt || 'Generated Ghibli style image'}
                                        fill
                        ...
                        {/* Prompt Input (Optional for Ghibli) */}
