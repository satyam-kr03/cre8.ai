        ...
        contents: [
          {
            parts: [
              {
                text: "Analyze this image. Describe its key elements, mood, and composition. Generate a short, evocative prompt suitable for transforming this image into a Anime-inspired art style, focusing on atmosphere and charm.",
              } as TextPart,
              {
                inline_data: {
          ...
          {isGeneratingImage ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-center text-gray-800">
                Anime Style Art Generator
              </h1>
              <p className="text-center text-gray-600 max-w-xl mb-8 px-4">
                Upload an image and transform it into charming anime art style.
              </p>
            </div>
          ) : (
            <div className="flex-1 flex flex-col items-center justify-center">
              <div className="relative w-full h-[calc(100vh-340px)] min-h-[300px] max-h-[60vh] rounded-xl overflow-hidden shadow-sm border border-gray-100 bg-gray-100 flex items-center justify-center">
                <Image
                  src={generatedImage}
                  alt={prompt || "Generated Anime style art"}
                  fill
