...
const AnimationGenerator = () => {
        ...
        contents: [
          {
            parts: [
              {
                text: "Analyze this image and generate a detailed, descriptive prompt suitable for generating an *animation* based on its content, style, and potential movement.",
              } as TextPart,
              {
                inline_data: {
  ...
  const generateAnimation = async () => {
    ...
    try {
      ...
      try {
        const gifBlob = await fetch(
          `data:image/gif;base64,${data.animation}`
        ).then((r) => r.blob());
          ...
          <div className="w-full md:w-[300px] bg-gray-50 p-5 overflow-y-auto border-r border-gray-200">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Upload an image to generate a prompt based on it.
              </p>
            </div>
                ...
                <h3 className="font-medium mb-2 text-gray-800 flex items-center">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M12 6V4m0 16v-2m8-8h2M4 12H2m15.364 6.364l1.414 1.414M4.222 19.778l1.414-1.414M19.778 4.222l-1.414 1.414M6.343 6.343l-1.414-1.414M12 18a6 6 0 100-12 6 6 0 000 12z"
                    />
                  </svg>
                  Guidance Scale
                </h3>
              ...
              <div className="flex-1 flex flex-col items-center justify-center">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={1}
                    d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M15 20v-4h-6v4M15 4V8H9V4"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <p className="text-center text-gray-600 max-w-xl mb-8 px-4">
                  Describe the animation you want to generate in the prompt
                  field below.
                </p>
              </div>
            ) : (
